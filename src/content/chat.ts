...
export const chatCopy: Localised<ChatCopy> = {
  ...
  ar: {
    open: "اسألي عن روزيكا",
    close: "إغلاق",
    title: "مساعدة روزيكا",
    subtitle: "إجابات عن العناية النباتية",
    greeting: "أهلًا بكِ في روزيكا. اختاري سؤالًا من الأسفل وسأجيبك — دون الحاجة للكتابة.",
    popular: "الأسئلة الأكثر شيوعًا",
    browse: "أو تصفّحي موضوعًا",
    ...
    disclaimer: "إجابات عن الأسئلة الشائعة. لأي أمر آخر، راسلينا على info@rosica.ae.",
    aiDisclaimer:
