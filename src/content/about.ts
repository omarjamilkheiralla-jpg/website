  ...
  ar: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: "نلتزم بابتكار جمال نباتي فاخر، فعّال وصادق، ومصنوع باحترام عميق للطبيعة ولك.",
        marks: [
    ...
    collectionsBody:
      "اكتشف تشكيلاتنا المنتقاة، كل واحدة طُوّرت بهدف واضح، وصُنعت من الطبيعة وصُقلت بالعلم.",
    ...
    promiseHeading: "وعدنا لك",
    promiseBody:
      "نلتزم بابتكار جمال نباتي فاخر، فعّال وصادق، ومصنوع باحترام عميق للطبيعة ولك.",
    promiseMarks: [
      "عناية نباتية بالشعر",
      "تركيبات مدروسة",
      "نتائج مرئية",
